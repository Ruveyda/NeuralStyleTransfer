...
# I think the problem is trying to do reshape with n_C as the first dimension - this must then reorder the tensor in the wrong way 
# (since the incoming tensor is shape [1, n_H, n_W, n_C])
# 
# If I do .reshape into [n_C, n_H*n_W], I get the result 11.345.
# However, if I do .reshape into [n_h*n_W, n_C] and then pass tf.transpose(a_G) into the gram matrix function, 
# 
# then I get the correct 9.19028.
